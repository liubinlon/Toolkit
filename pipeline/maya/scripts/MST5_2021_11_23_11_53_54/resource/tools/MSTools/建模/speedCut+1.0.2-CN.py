...
def jwSpeedCutUI():
    ...
    mc.text(l ='')
    mc.button('setBaseButton',w = 50, l= "设置", c = 'setCutterBaseMesh()', bgc = [0.24, 0.24, 0.24 ] )
    mc.text(l ='')
    mc.button('freeResultButton',w = 35, l= "完成", c = 'freeResultMesh()', bgc = [0.54, 0.24, 0.24 ] )
    mc.setParent( '..' )
    ...
    mc.text(l ='')
    mc.button(w = 40, l= "冻结", c ='boolSymmetryFreeze()', bgc =  [0.54, 0.24, 0.24 ] )
    mc.setParent( '..' )
    mc.separator( height= 15, style='none' )
    
    mc.rowColumnLayout(nc=8 ,cw=[(1,40),(2, 58),(3,5),(4, 58),(5,5),(6,58),(7,5),(8,58)])
    mc.text(l ='显示',h=20)
    mc.iconTextButton('ToggleCutters',  w=40,style='textOnly', l= "开关", rpt = True, c = 'toggleCutters()', bgc = [0.24,0.24,0.24 ] )
    mc.text(l ='')
    mc.iconTextButton( w = 40, style='textOnly', l= "所有", c = 'showAllCutter()', bgc =   [0.24, 0.24, 0.24] )
    mc.text(l ='')
    mc.iconTextButton( w = 40, style='textOnly', l= "无", c = 'hideAllCutter()', bgc =  [0.24, 0.24, 0.24] )
    mc.text(l ='',h=20)
    mc.iconTextButton( w = 40, style='textOnly', l= "选择", rpt = True, c = 'showLastCutter()', bgc = [0.24,0.24,0.24] )
    mc.setParent( '..' )
    mc.text(l ='')
    ...
    mc.iconTextButton('drawCutButton', h= 23 ,w = 50,  style='textOnly', l= "绘制", rpt = True, c = 'goDraw()', bgc = [0.49,0.6,0.36 ] )
    mc.setParent( '..' ) 
    mc.text(l ='')
    mc.columnLayout()
    ...
    mc.setParent( '..' ) 
    mc.columnLayout()
    mc.iconTextButton('selCutButton', w = 100,  style='textOnly', l= "已选择", rpt = True, c = 'useOwnCutterShape()', bgc = [0.26, 0.56, 0.39] )
    mc.setParent( '..' ) 
    mc.setParent( '..' ) 
    mc.columnLayout()
    mc.iconTextButton('dulCutButton', w = 80,  style='textOnly', l= "复制", rpt = True, c = 'cutterDulpicate()', bgc = [0.24, 0.24, 0.24] )
    mc.separator( height= 4, style='none' )
    mc.iconTextButton('comCutButton', w = 80,  style='textOnly', l= "合并", rpt = True, c = 'combineSelCutters()', bgc = [0.24, 0.24, 0.24] )
    mc.setParent( '..' )   
    mc.setParent( '..' )
    mc.separator( height= 5, style='none' )
    mc.columnLayout()
    ...
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='旋转',h=20)
    mc.iconTextButton(w = 50, style='textOnly', l= "开关",rpt = True, c = 'QChangeCutterDir()', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.iconTextButton(w = 50,style='textOnly' , l= "对齐", rpt = True, c = 'alignCutterToBase()', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.setParent( '..' )
    mc.separator( height=15, style='none' )
    ...
    mc.columnLayout()
    mc.floatSliderGrp('fractionSlider', en=0, v = 0.2, min = 0.001, max = 1,  s = 0.01, cw3 = [55,40,140] , label = " 分数" ,field =True)
    mc.intSliderGrp('segmentSlider',    en=0, v = 1,   min = 1 ,    max = 10,  fmx = 20, s = 1, cw3 = [55,40,140] , label = "分段数" ,field =True)
    mc.floatSliderGrp('depthSlider',    en=0, v = 1,   min = -1 ,   max = 1, fmn = -3, fmx = 3, s = 1,  cw3 = [55,40,140] , label = "深度" ,field =True)
    mc.floatSliderGrp('gapSlider',      en=0, v = 0.3, min = 0.01, max = 1,  s = 0.01, cw3 = [55,40,140] , label = "间隙" ,field =True)
    mc.setParent( '..' )
    mc.text(l ='',h=20)
    mc.button( w = 30, l= "连接", c = 'QlinkSlider()', bgc = [0.08,0.08,0.08] )
    mc.setParent( '..' )
    mc.text(l ='')
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='类型',h=20)
    mc.button( w = 50, l= "倒角", c = 'QBoxBevel()', bgc = [0.08,0.08,0.08] )
    mc.text(l ='')
    mc.button(w = 50, l= "圆滑", c = 'QBoxSmooth()', bgc =   [0.08,0.08,0.08])
    mc.text(l ='')
    ...
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='镶嵌',h=10)
    mc.button('makePanelButton', w = 50,  l= "镶嵌/间隙", c = 'toggleCapPanel()', bgc = [0.08,0.08,0.08] )
    mc.text(l ='')
    mc.button('reBuildButton', w = 50, l= "重建", c = 'reBuildCutter()', bgc = [0.08,0.08,0.08] )
    mc.text(l ='')
    ...
    mc.rowColumnLayout(nc=3 ,cw=[(1,240),(2,12),(3,30)])
    mc.columnLayout()
    mc.intSliderGrp('instNumSlider', en=0,  v = 1,   min = 1,    max = 10,  fmx = 20 ,s = 1, cw3 = [35,40,160] , label = "数量" ,field =True,dc = 'instReNew()' )
    mc.floatSliderGrp('disSlider', en=0,  v = 1,   min = -3,    max = 3,  fmx = 20 ,fmn = -20, s = 0.01, cw3 = [35,40,160] , label = "距离", field =True, )
    mc.setParent( '..' )
    mc.text(l ='',h=5)
    mc.button('instLinkButton', w = 30, l= "连接", c = 'instLink()', bgc = [0.24, 0.20, 0.24] )
    mc.setParent( '..' )
    mc.separator( height=5, style='none' )
    mc.columnLayout()
    ...
    mc.text(l ='排列')
    mc.text(l ='')
    mc.radioButtonGrp('arrayTypeButton', numberOfRadioButtons = 2, sl= 1, labelArray2 = ['线性', '辐射'],cc = 'instTypeCommandChange()',cw2 =(50,80))
    mc.button( w = 45, l= "转换", c = 'instTypeToggle()', bgc = [0.24, 0.20, 0.24] )
    mc.text(l ='')
    mc.button( w = 45, l= "完成", c = 'instBake()', bgc = [0.24, 0.20, 0.24] )
    mc.text(l ='')
    ...
    mc.text(l ='',h=10)
    mc.button('snapGridVisButton', w = 50,   l= "开关", c = 'drawGirdToggle()', bgc = [0.36, 0.6, 0.49] )
    mc.text(l ='')
    mc.button('snapGridPointVisButton', w = 50,   l= "点", c = 'goPressDraw()', bgc = [0.49, 0.6, 0.36] )
    mc.text(l ='')
    mc.button('cureveDrawButtton', w = 50,  l= "绘制", c = 'mc.CVCurveToolOptions()',bgc = [0.24, 0.24, 0.24] )
    mc.text(l ='')
    mc.button('buildBlockButton', w = 50,   l= "块",  c = 'makeDrawBlock()', bgc = [0.24, 0.24, 0.24] )
    mc.textField("camPlane" ,ed =False,w = 20,vis=0)
    mc.setParent( '..' )
    mc.separator( height=15, style='none' )    
    mc.columnLayout()
    mc.intSliderGrp('snapGirdSize', en=0, v = 10,  min = 1, max = 50,  fmx=100 ,s = 1, cw3 = [35,40,200] , label = "网格" ,field =True, dc ='resizeSnapGrid()')
    ...
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='',h=10)
    mc.button('bakeUnSelButton', w = 50,   l= "未选择", c = 'bakeUnselectCutter()', bgc = [0.1,0.2,0.2] )
    mc.text(l ='')
    mc.button('bakeAllButton', w = 50,   l= "所有", c = 'bakeCutter()', bgc = [0.2,0.1,0.1] )
    mc.text(l ='')
    mc.button('bakeRestoreButton', w = 50,  l= "恢复",c = 'restoreCutter()', bgc = [0.08,0.08,0.08] )
    mc.text(l ='')
    mc.setParent( '..' )
    ...
    mc.text(l ='',h=20)
    mc.iconTextButton('preBevelButton',  w=40,style='textOnly', l= "开/关", rpt = True, c = 'preBevelToggle()', bgc = [0.49,0.6,0.36 ] )
    mc.text(l ='',h=20)
    mc.iconTextButton('preBevelSettingButton',  w=40,style='textOnly', l= "设置", rpt = True, c = 'bevelPreviewSetting()', bgc =[0.24, 0.24, 0.24] )
    mc.text(l ='',h=20)
    mc.setParent( '..' )
    mc.frameLayout( 'bevelPreSettingLayer', labelVisible = 0,vis = 0)
    mc.floatSliderGrp('offsetSliderPre', en=1, v = 0.1, min = 0.001, max = 1, fmx = 10, s = 0.01, cw3 = [55,40,180] , label = "偏移" ,field =True)
    mc.text(l ='',h=20)
