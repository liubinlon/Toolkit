...
def jwSpeedCutUI():
    ...
    jwSpeedCutWin = mc.window("jwSpeedCutWin",title = "speedCut 1.62", mxb = False, s = 1 ,bgc = [0.2, 0.2, 0.2  ])
    mc.scrollLayout()
    mc.columnLayout()
    mc.frameLayout( cll= 1, cl= 0, label= "设置模型" ,  bgc =[0.14,0.14,0.14] , w= 300)
    mc.rowColumnLayout(nc= 4 ,cw=[(1,70),(2,140),(3, 5),(4,80)])
    mc.text(l ='基础模型')
    mc.optionMenu('baseMeshMenu',  bgc =[0.28,0.28,0.28], bsp ='checkBaseMeshList()' ,cc='loadSymmetryState(),cageVisToggle(),showAllCutter(),updateVisLayer(),updateSnapState(),fadeOutCage()')
    mc.menuItem("NoBaseMeshMenu", label='无基础模型' )
    mc.text(l ='')
    mc.button('setBaseButton', l= "设置", c = 'checkBaseMeshList(),setCutterBaseMesh(),baseMeshColorUpdate(),updateVisLayer()' ,  bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    ...
    mc.text(l ='')
    mc.button('reTargetButton', l= "重设目标", c = 'reTarget()',  bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button('freeResultButton', l= "完成", c = 'freeResultMesh()',  bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )

    #######################################################################################################################################################################################
    mc.frameLayout( cll= 1, cl= 0, label= "网格对称" ,   bgc =[0.14,0.14,0.14] , w= 300)
    buttonSize = 25
    ...
    mc.text(l ='')
    mc.button( l= "重置", c ='boolSymmetryReset()', bgc =  [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button( l= "冻结", c ='boolSymmetryFreeze()', bgc =  [0.28,0.28,0.28] )
    mc.setParent( '..' )
    ...
    mc.text(l ='')
    mc.button( l= '开/关', w = 35, bgc = [0.28,0.28,0.28],c='cageVisToggle()')
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.setParent( '..' )
    #######################################################################################################################################################################################
    mc.frameLayout( cll= 1, cl= 0, label= "切割" ,  bgc = [0.14,0.14,0.14] , w= 300)
    mc.rowColumnLayout(nc=8 ,cw=[(1,40),(2, 58),(3,5),(4, 58),(5,5),(6,58),(7,5),(8,58)])
    mc.text(l ='  显示',h=20)
    mc.iconTextButton(w=40,style='textOnly', l= "已选择", rpt = True, c = 'hideUnSelectedCutters()', bgc = [0.28,0.28,0.28])
    mc.text(l ='')
    mc.iconTextButton( w = 40, style='textOnly', l= "所有", c = 'showAllCutter()', bgc = [0.28,0.28,0.28])
    mc.text(l ='')
    mc.iconTextButton( w = 40, style='textOnly', l= "无", c = 'hideAllCutter()', bgc = [0.28,0.28,0.28])
    mc.text(l ='',h=20)
    mc.iconTextButton( w = 40, style='textOnly', l= "循环", rpt = True, c = 'showLastCutter()', bgc = [0.28,0.28,0.28])
    mc.setParent( '..' )
    ...
    mc.iconTextButton('newCutButton', h= 27 ,w = 50,  style='textOnly', l= "[ * ]", rpt = True, c = 'goPressCutter(4)', bgc = [0.28,0.28,0.28] )
    mc.separator( height= 3, style='none' )
    mc.iconTextButton('drawCutButton', h= 27 ,w = 50,  style='textOnly', l= "绘制", rpt = True, c = 'goDraw()', bgc = [0.28,0.28,0.28])
    mc.setParent( '..' )
    ...
    mc.setParent( '..' )
    mc.columnLayout()
    mc.iconTextButton('selCutButton', w = 100,  style='textOnly', l= "已选择", rpt = True, c = 'useOwnCutterShape()', bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.columnLayout()
    mc.iconTextButton('dulCutButton', w = 80,  style='textOnly', l= "复制", rpt = True, c = 'cutterDulpicate()', bgc = [0.28,0.28,0.28] )
    mc.separator( height= 4, style='none' )
    mc.iconTextButton('comCutButton', w = 80,  style='textOnly', l= "合并", rpt = True, c = 'combineSelCutters()', bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.columnLayout()
    mc.floatSliderGrp('cutterScaleSlider',  v = 1, min = 0.1, max = 5,  s = 0.1, cw3 = [40,50,190] , label = "缩放  " ,field =True)
    mc.floatField( 'cuterPreSize' , value=1 ,vis=0 )
    mc.setParent( '..' )
    mc.rowColumnLayout(nc=8, cw=[(1,40),(2,58),(3,5),(4,58),(5,5),(6,58),(7,5),(8,58)])
    mc.text(l ='操作器',h=10)
    mc.button('subsButton',  l= "差集", c = 'cutterType("subs")', bgc = [0.3, 0.5, 0.6] )
    mc.text(l ='')
    mc.button('unionButton', l= "并集", c ='cutterType("union")', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button('cutButton', l= "切割后", c ='cutterType("cut")', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button('cutToNewMeshButton', l= "新组", c ='cutter2NewMeshGrp()', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.setParent( '..' )
    mc.columnLayout()
    ...
    mc.setParent( '..' )
    ########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 1, label= "控制" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='',h=20)
    mc.button( w = 50, l= "倒角", c = 'QBoxBevel()', bgc = [0.28,0.28,0.28])
    mc.text(l ='')
    mc.button(w = 50, l= "平滑", c = 'QBoxSmooth()',bgc = [0.28,0.28,0.28])
    mc.text(l ='')
    mc.button(w = 50, l= "移除", c = 'QBoxBevelRemove()',bgc = [0.28,0.28,0.28])
    mc.setParent( '..' )
    mc.rowColumnLayout()
    mc.columnLayout()
    mc.floatSliderGrp('fractionSlider',  v = 0.2, min = 0.001, max = 1,  s = 0.01, cw3 = [55,40,180] , label = " 分数" ,field =True,cc = 'attributeFloatSlider("fraction")',dc = 'attributeFloatSlider("fraction")')
    mc.intSliderGrp('segmentsSlider',     v = 1,   min = 1 ,    max = 10,  fmx = 20, s = 1, cw3 = [55,40,180] , label = "分段" ,field =True ,cc= 'attributeIntSlider("segments")',dc= 'attributeIntSlider("segments")')
    mc.floatSliderGrp('depthSlider',     v = 1,   min = -1 ,   max = 1,   fmn = -3, fmx = 3, s = 1,  cw3 = [55,40,180] , label = "深度" ,field =True,cc = 'attributeFloatSlider("depth")',dc = 'attributeFloatSlider("depth")')
    mc.setParent( '..' )
    mc.text(l ='')
    mc.separator( height=5, style='none' )
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='',h=10)
    mc.button('makePanelButton', w = 50,  l= "间隔", c = 'makeGap()',bgc = [0.28,0.28,0.28])
    mc.text(l ='')
    mc.button('ScrapeButton', w = 50,  l= "刮削", c = 'scrapeCutter()',bgc = [0.28,0.28,0.28])
    mc.text(l ='')
    mc.button('removePanelButton', w = 50,  l= "移除", c = 'removeGap()',bgc = [0.28,0.28,0.28])
    mc.setParent( '..' )
    mc.rowColumnLayout()
    mc.columnLayout()
    mc.floatSliderGrp('gapSlider',   v = 0.3, min = 0.01, max = 5, fmx = 20,  s = 0.01, cw3 = [55,40,180] , label = "间隔" ,field =True,cc='attributeGapSlider()',dc = 'attributeGapSlider()')
    mc.floatSliderGrp('scrapeSlider',  v = 0.3, min = 0.01, max = 1,  fmx = 5, s = 0.01, cw3 = [55,40,180] , label = "刮削" ,field =True)
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.setParent( '..' )
    ########################################################################################################################################################################
    mc.frameLayout( cll= 1, cl= 1, label= "对齐" ,  bgc = [0.14,0.14,0.14] , w= 300)
    ...
    mc.button('borderAlginButton', l= '开/关', w = 50, bgc = [0.28,0.28,0.28],c='borderAlginBBoxToggle()')
    mc.setParent( '..' )
    mc.rowColumnLayout(nc=8, cw=[(1,40),(2,50),(3,5),(4,50),(5,5),(6,50),(7,10),(8,80)])
    mc.text(l ='轴向',h=20)
    ...
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='吸附')
    mc.iconTextButton(w = 50,style='textOnly' , l= "边界", rpt = True, c = 'alignCutterToBase()', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.iconTextButton(w = 50,style='textOnly' , l= "最后切割", rpt = True, c = 'alignLastCutter()', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.iconTextButton(w = 50,style='textOnly' , l= "选择的切割", rpt = True, c = 'alignSelCutter()', bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='整齐',h=20)
    mc.iconTextButton(w = 50,style='textOnly' , l= "左 / 右", rpt = True, c = 'evenObjLineUp("x")', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.iconTextButton(w = 50,style='textOnly' , l= "上/ 下", rpt = True, c = 'evenObjLineUp("y")', bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.setParent( '..' )
    ########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 1, label= "样式" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=8, cw=[(1,40),(2,50),(3,5),(4,50),(5,5),(6,50),(7,10),(8,80)])
    mc.text(l ='类型',h=20)
    mc.button('arrayLinear', l= "线性",  c = 'toggleArrayType()', bgc = [0.3, 0.5, 0.6] )
    mc.text(l ='')
    mc.button('arrayRadial' , l= "放射状", c = 'toggleArrayType()', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.text(l ='')
    mc.text(l ='')
    mc.button( l= "冻结", c = 'instBake()', bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.rowColumnLayout(nc=8, cw=[(1,40),(2,50),(3,5),(4,50),(5,5),(6,50),(7,10),(8,80)])
    mc.text(l ='轴向',h=20)
    ...
    mc.text(l ='')
    mc.button(  l= "移除", c = 'removeArrayGrp()', bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.rowColumnLayout()
    mc.columnLayout()
    mc.intSliderGrp('instNumSlider',  v = 1,   min = 1,    max = 10,  fmx = 20 ,s = 1, cw3 = [55,40,180] , label = "数字" ,field =True,cc = 'instReNew()',dc = 'instReNew()' )
    mc.floatSliderGrp('disSlider', v = 1,   min = -3,    max = 3,  fmx = 20 ,fmn = -20, s = 0.01, cw3 = [55,40,180] , label = "距离", field =True, cc ='instDistanceUpdate()',dc ='instDistanceUpdate()')
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.setParent( '..' )
    ##########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 1, label= "实时绘制" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=7 ,cw=[(1,40),(2, 78),(3,5),(4, 78),(5,5),(6,78)])
    mc.text(l ='网格')
    mc.iconTextButton('snapGridCameraVisButton', w = 50,   style='textOnly', l= "相机", c = 'snapGridCamera()', rpt = True, bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.iconTextButton('snapGridPointVisButton', w = 50,   style='textOnly', l= "点", c = 'goPressDraw()', rpt = True, bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.iconTextButton('snapGridVisToggleButton', w = 50,   style='textOnly', l= "移除", c = 'drawGirdOff()', rpt = True, bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.columnLayout()
    mc.intSliderGrp('snapGirdSize', v = 10,  min = 1, max = 50,  fmx=100 ,s = 1, cw3 = [35,40,200] , label = "网格" ,field =True, dc ='resizeSnapGrid()')
    mc.intSliderGrp('snapGirdRot', v = 0,   min = 0, max = 90,  s = 1, cw3 = [35,40,200], label = "旋转" ,field =True , dc ='rotateSnapGrid()')
    mc.floatSliderGrp('snapGirdOffset',  v = 0.1,   min = 0.01,    max = 3,  fmx = 20 ,s = 0.01, cw3 = [35,40,200] , label = "偏移", field =True ,dc ='offsetSnapGrid()')
    mc.setParent( '..' )
    mc.rowColumnLayout(nc=6 ,cw=[(1,40),(2, 78),(3,5),(4, 78),(5,5),(6,78)])
    mc.text(l ='工具')
    mc.button('cureveDrawButtton', w = 50,  l= "绘制曲线", c = 'drawCurveNow()',bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button('buildBlockButton', w = 50,   l= "成块状",  c = 'makeDrawBlock()',bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.setParent( '..' )
    ##########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 1, label= "烘焙" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='',h=10)
    mc.button('bakeUnSelButton', w = 50,   l= "未选择", c = 'bakeCutter("unselect")', bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button('bakeAllButton', w = 50,   l= "所有", c = 'bakeCutter("all")',bgc = [0.28,0.28,0.28] )
    mc.text(l ='')
    mc.button('bakeRestoreButton', w = 50,  l= "恢复",c = 'restoreCutterWithSymmtry()',bgc = [0.28,0.28,0.28] )
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.frameLayout(cll= 1, cl= 0, label= "网格倒角管理器" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=4 ,cw=[(1,80),(2, 185),(3,5),(4, 58)])
    mc.text(l ='',h=20)
    mc.iconTextButton('preBevelButton',  w=40,style='textOnly', l= "倒角管理器", rpt = True, c = 'jwSpeedCutBevelMangerSetup()', bgc = [0.14, 0.14, 0.14] )
    mc.separator( height=15, style='none' )
    mc.setParent( '..' )
    mc.separator( height=15, style='none' )
    mc.showWindow(jwSpeedCutWin)
    mc.window("jwSpeedCutWin",e=True,w = 320,h = 800)
...
def combineSelCutters():#only work with same type of OP
    beseMesh = mc.optionMenu('baseMeshMenu', query = True, v = True)
    ...
    if len(selList) > 1:
        ...
        if (subsGrp + unionGrp + cutGrp) == 1:       
            ...
            print ('only work for the same type of cutter operation!')
