...
def mz_ccUI():
    #initial the window
    ccWin = cmds.window(mz_ccWin, title = 'mz_ctrlCreator v1.0.0 by Mingquan Zhou', resizeToFitChildren = 1,  sizeable = 1)
    ...
    cmds.symbolButton(image = 'mz_icons/ccButton04.PNG', command = mz_ccButtonSnap04)
    cmds.symbolButton(image = 'mz_icons/ccButton05.PNG', command = mz_ccButtonSnap05)
    cmds.symbolButton(image = 'mz_icons/ccButton06.PNG', command = mz_ccButtonSnap06)
    cmds.symbolButton(image = 'mz_icons/ccButton07.PNG', command = mz_ccButtonSnap07)
    cmds.symbolButton(image = 'mz_icons/ccButton08.PNG', command = mz_ccButtonSnap08)
    cmds.symbolButton(image = 'mz_icons/ccButton09.PNG', command = mz_ccButtonSnap09)
    cmds.symbolButton(image = 'mz_icons/ccButton10.PNG', command = mz_ccButtonSnap10)
    cmds.symbolButton(image = 'mz_icons/ccButton11.PNG', command = mz_ccButtonSnap11)
    cmds.symbolButton(image = 'mz_icons/ccButton12.PNG', command = mz_ccButtonSnap12)
    cmds.symbolButton(image = 'mz_icons/ccButton13.PNG', command = mz_ccButtonSnap13)
    cmds.symbolButton(image = 'mz_icons/ccButton14.PNG', command = mz_ccButtonSnap14)
    cmds.symbolButton(image = 'mz_icons/ccButton15.PNG', command = mz_ccButtonSnap15)
    cmds.symbolButton(image = 'mz_icons/ccButton16.PNG', command = mz_ccButtonSnap16)
    cmds.symbolButton(image = 'mz_icons/ccButton17.PNG', command = mz_ccButtonSnap17)
    cmds.symbolButton(image = 'mz_icons/ccButton18.PNG', command = mz_ccButtonSnap18)
    cmds.symbolButton(image = 'mz_icons/ccButton19.PNG', command = mz_ccButtonSnap19)
    cmds.symbolButton(image = 'mz_icons/ccButton20.PNG', command = mz_ccButtonSnap20)
    cmds.symbolButton(image = 'mz_icons/ccButton21.PNG', command = mz_ccButtonSnap21)
    cmds.symbolButton(image = 'mz_icons/ccButton22.PNG', command = mz_ccButtonSnap22)
    cmds.symbolButton(image = 'mz_icons/ccButton23.PNG', command = mz_ccButtonSnap23)
    cmds.symbolButton(image = 'mz_icons/ccButton24.PNG', command = mz_ccButtonSnap24)
    cmds.symbolButton(image = 'mz_icons/ccButton25.PNG', command = mz_ccButtonSnap25)
    cmds.symbolButton(image = 'mz_icons/ccButton26.PNG', command = mz_ccButtonSnap26)
    cmds.symbolButton(image = 'mz_icons/ccButton27.PNG', command = mz_ccButtonSnap27)
    cmds.symbolButton(image = 'mz_icons/ccButton28.PNG', command = mz_ccButtonSnap28)
    cmds.symbolButton(image = 'mz_icons/ccButton29.PNG', command = mz_ccButtonSnap29)
    cmds.symbolButton(image = 'mz_icons/ccButton30.PNG', command = mz_ccButtonSnap30)
    cmds.symbolButton(image = 'mz_icons/ccButton31.PNG', command = mz_ccButtonSnap31)
    cmds.symbolButton(image = 'mz_icons/ccButton32.PNG', command = mz_ccButtonSnap32)
    cmds.symbolButton(image = 'mz_icons/ccButton33.PNG', command = mz_ccButtonSnap33)
    cmds.symbolButton(image = 'mz_icons/ccButton34.PNG', command = mz_ccButtonSnap34)
    cmds.symbolButton(image = 'mz_icons/ccButton35.PNG', command = mz_ccButtonSnap35)
    cmds.symbolButton(image = 'mz_icons/ccButton36.PNG', command = mz_ccButtonSnap36)
    cmds.symbolButton(image = 'mz_icons/ccButton37.PNG', command = mz_ccButtonSnap37)
    cmds.symbolButton(image = 'mz_icons/ccButton38.PNG', command = mz_ccButtonSnap38)
    cmds.symbolButton(image = 'mz_icons/ccButton39.PNG', command = mz_ccButtonSnap39)
    cmds.symbolButton(image = 'mz_icons/ccButton40.PNG', command = mz_ccButtonSnap40)
    cmds.symbolButton(image = 'mz_icons/ccButton41.PNG', command = mz_ccButtonSnap41)
    cmds.symbolButton(image = 'mz_icons/ccButton42.PNG', command = mz_ccButtonSnap42)
    cmds.symbolButton(image = 'mz_icons/ccButton43.PNG', command = mz_ccButtonSnap43)
