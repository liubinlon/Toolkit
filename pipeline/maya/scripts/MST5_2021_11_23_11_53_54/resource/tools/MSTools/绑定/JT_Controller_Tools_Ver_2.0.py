...
def attachControllersToSkin():
    ...
    for item in selected:
    	...
    	folicleTranslateNode = mc.listRelatives(Folicle,ap=True)[0]
    	if bShouldConstrainOrientation:
    	    mc.parentConstraint(folicleTranslateNode, circleName + "_follow_grp")
    	else:
    	    mc.pointConstraint(folicleTranslateNode, circleName + "_follow_grp")
