...
maya_main_window = wrapInstance(long(mayaPtr), QtWidgets.QWidget)
...
class Playblast(QtWidgets.QWidget):
    def __init__(self, parent=None):
        super(Playblast, self).__init__(parent=parent)
        ...
        self.resize(300, 30)
        self.btn = screen.btn()
        #bulid a widget about renaming files
        ...
        self.ledt_name.setPlaceholderText(u"  默认为当前文件名")
        self.gridLayout_name.addWidget(self.lbl_name, 0, 0, 1, 1) 
        self.gridLayout_name.addWidget(self.ledt_name, 0, 1, 1, 1)
        #bulid a widget about take screen information display settings
        ...
        self.sbx_size = QtWidgets.QDoubleSpinBox(self.gbox_font)
        self.sbx_size.setMinimum(0.1)
        self.sbx_size.setMaximum(1)
        self.sbx_size.setValue(1)
        self.sbx_size.setSingleStep(0.1)
        #self.sbx_size.setSpecialValueText("1")
        ...
        #bulid a widget about take screen settings
    ...
    def setupUi(self):
        ...
        self.cbx_color.insertItem(0, QtGui.QIcon(r"{0}/yellow.png".format(path)), "yellow")
        ...
        self.cbx_color.insertItem(3, QtGui.QIcon(r"{0}/white.png".format(path)), "white")
        

 
        self.lbl_size.setText("size:")
        self.cbx_format.addItems(["qt"])
        ...
        self.btn.heightValue = self.ledt_height
...
def main():
    get_win_strat(NAME)
    win = Playblast(parent=maya_main_window)
    win.show()
