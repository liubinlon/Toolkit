...
//Name: gorilla.ma
//Last modified: Wed, Dec 07, 2016 10:07:45 AM
//Codeset: 1252
requires maya "2008";
...
createNode joint -n "PinkyToe2" -p "PinkyToe1";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 2.3391320895676057e-006 -1.1574516071575679e-005 -11.425209964045624 ;
	setAttr ".typ" 5;
	setAttr -k on ".fat" 0.2;
	setAttr ".fatYabs" 0.20000000298023224;
	setAttr ".fatZabs" 0.20000000298023224;
...
createNode joint -n "Shoulder" -p "Scapula";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -9.7123335456009349e-016 -35.046165545059658 24.140909746175922 ;
